...
- [`riskTable()`](https://darwin-eu.github.io/CohortSurvival/reference/riskTable.md)
  : Table with survival events
- [`optionsTableSurvival()`](https://darwin-eu.github.io/CohortSurvival/reference/optionsTableSurvival.md)
...
- [`mockMGUS2cdm()`](https://darwin-eu.github.io/CohortSurvival/reference/mockMGUS2cdm.md)
